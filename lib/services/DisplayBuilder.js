...
export default class DisplayBuilder {
  ...
  static build(spotifyStateDetails){
    ...
    return `${playerStateImageUrl} ${spotifyStateDetails.song} by ${spotifyStateDetails.artist} from ${spotifyStateDetails.album} (${spotifyStateDetails.songPosition} of ${spotifyStateDetails.songDuration})`;
  }
