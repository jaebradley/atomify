...
export default class DisplayBuilder {
  ...
  static build(spotifyStateDetails){
    ...
    return `<img src=${playerStateImageUrl} /> ${playerSettingImageUrl} ${spotifyStateDetails.song} by ${spotifyStateDetails.artist} from ${spotifyStateDetails.album} (${spotifyStateDetails.songPosition} of ${spotifyStateDetails.songDuration})`;
  }
