...
export default class DisplayBuilder {
  ...
  static buildSettingsDetails(spotifyStateDetails) {
    ...
    const defaultSettings = `<img src=${spotifyIconUrl} /> <img src=${playerStateImageUrl} />`;
  ...
  static getPlayerSettingImages(isShuffling, isRepeating) {
    ...
    let images = '';
    if (isShuffling) {
      images += `<img src='https://raw.githubusercontent.com/jaebradley/atomify/master/images/shuffle.png?raw=true' />`;
    }

    if (isRepeating) {
      images += `<img src='https://raw.githubusercontent.com/jaebradley/atomify/master/images/repeat.png?raw=true' />`;
    }
