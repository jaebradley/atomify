...
SpotifyCommands.initEnum({
  ...
  GET_ALBUM_ARTWORK_URL: {
    value: 'tell application "Spotify" to artwork url of current track as string'
  },
  GET_ARTIST: {
  ...
  TURN_OFF_REPEAT: {
    value: 'tell application "Spotify" to set repeating to false'
  },
  TURN_ON_REPEAT: {
    value: 'tell application "Spotify" to set repeating to true'
  },
  TURN_OFF_SHUFFLE: {
    value: 'tell application "Spotify" to set shuffling to false'
  },
  TURN_ON_SHUFFLE: {
    value: 'tell application "Spotify" to set shuffling to true'
  },
  IS_SHUFFLING: {
  ...
  IS_SPOTIFY_RUNNING: {
    value: 'application "Spotify" is running'
  },
  GO_TO_NEXT_TRACK: {
    value: 'tell application "Spotify" to next track'
  },
  GO_TO_PREVIOUS_TRACK: {
    value: 'tell application "Spotify" to previous track'
  },
  TOGGLE_PLAY_PAUSE: {
    value: 'tell application "Spotify" to playpause'
  }
})
