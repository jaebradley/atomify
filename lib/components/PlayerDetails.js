    ...
    return (
      <div id={ "atomify-player-details" }>
        { stateIconSource != null &&
          <img id={ "atomify-player-state-icon" } src={ stateIconSource } />
        }
        { this.props.isShuffling &&
          <img id={ "atomify-player-shuffle-icon" } src={ this.getShuffleIconSource() } />
        }
        { this.props.isRepeating &&
          <img id={ "atomify-player-repeat-icon" } src={ this.getRepeatIconSource() } />
        }
      </div>
    );
  },
